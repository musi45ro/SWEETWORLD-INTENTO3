...
function food_restaurant_admin_theme_style() {
   wp_enqueue_style( 'food-restaurant-font', food_restaurant_admin_font_url(), array() );
...
// Theme Font URL
function food_restaurant_admin_font_url() {
	$font_url = '';
	$font_family = array();
...
<div class="wrapper-info">
	<div class="top-section">
	    ...
	    <div class="info-link">
			...
			<a href="<?php echo esc_url( FOOD_RESTAURANT_DEMO_DATA ); ?>" target="_blank"><?php esc_html_e('Demo Data', 'food-restaurant'); ?></a>
